...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    // when 0 secods, stop timer and logout user
    if (time === 0) {
      clearInterval(timer);
...
console.log('Browser      ', new Intl.NumberFormat(navigator.language, options).format(number), navigator.language);
...
if (ingredients.includes('spinaches')) clearTimeout(pizzaTimmer);
